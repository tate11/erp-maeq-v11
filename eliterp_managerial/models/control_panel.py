...
class ControlPanelInstitution(models.Model):
    _name = 'eliterp.control.panel.institution'

    name = fields.Char('Nombre de institución', required=True)

    _sql_constraints = [
        ('name_unique', 'unique (name)', "Ya existe nombre de institución en registros.")
    ]
...
class ControlPanelLine(models.Model):
    ...
    name_panel = fields.Many2one('eliterp.control.panel.institution', 'Institución', related="control_panel_id.name", store=True)
...
class ControlPanel(models.Model):
    ...
    name = fields.Many2one('eliterp.control.panel.institution', 'Institución', required=True)
