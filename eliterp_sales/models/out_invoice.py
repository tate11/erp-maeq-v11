...
class AccountInvoice(models.Model):
    ...
    have_discount = fields.Boolean('Lleva descuento?', default=False, readonly=True,
    ...
    attach_invoice_ = fields.Binary('Acta de entrega', attachment=True)
    attached_name_ = fields.Char('Nombre de adjunto')
